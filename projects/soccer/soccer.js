/*
 * Celestial Thunder Soccer Schedule App – ICS Parsing & Match Recaps. 
 * This snippet is from my browser-based schedule app I built for my intramural soccer team, Celestial Thunder. 
 * It parses a standard .ics calender file exported from our league’s scheduling system into structured JavaScript game objects. 
 * Handles multi-line folding, escaped characters, and both UTC and local date-time formats. 
 * Cross-references each parsed game against a separate JSON file of game recaps, matching them by date and by home/away team name 
 * so final scores and recap links can be displayed alongside upcoming/past games. 
 * This is hosted on my GitHub Pages and needs no backend or database to function.
 */
